// Builds and exports the configured Express app WITHOUT calling listen(), so
// tests (supertest) can mount it in-process and the real entrypoint (index.js)
// can bind a port. dotenv must load first so db.js reads DB_* at pool creation.
