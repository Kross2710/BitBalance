...
$activePage = 'orders'; // Set the active page for the sidebar

$orders = getAllOrders(); // Fetch all products for the product list
...
$statuses = ['completed', 'pending', 'processing', 'cancelled']; // Define order statuses
?>
